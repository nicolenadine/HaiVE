...
base.py — VCSAdapter protocol defining version control interface
  VCSAdapter (class) — 4-17 — Protocol for VCS operations including branch, PR, and merge management
github.py — GitHub implementation of VCS adapter using PyGithub and GraphQL
  GitHubVCSAdapter (class) — 14-196 — Concrete GitHub adapter for branch management, PR creation, and merging
