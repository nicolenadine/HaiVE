...
base.py — PMAdapter protocol defining interface for project management integrations
  PMAdapter (class) — 8-17 — Protocol specifying read/write methods for task management
...
github.py — GitHub Projects v2 adapter implementing project and task operations
  GitHubPMAdapter (class) — 73-439 — Full-featured adapter syncing tasks with GitHub issues and projects
  _GitHubIssue (class) — 50-62 — Pydantic model representing a GitHub issue with haive custom fields
  _GitHubMilestone (class) — 65-70 — Pydantic model representing a GitHub milestone
