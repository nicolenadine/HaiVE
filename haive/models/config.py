...
class Settings(BaseSettings):
    ...
    # Low tier
    tier_low_models: list[str] = Field(default=["anthropic/claude-haiku-4-5-20251001", "openai/gpt-4o-mini"])
    tier_low_max_attempts: int = 2
    tier_low_context_budget: int = 8000

    # Medium tier
    tier_medium_models: list[str] = Field(default=["anthropic/claude-sonnet-4-6", "openai/gpt-4o"])
    tier_medium_max_attempts: int = 2
    tier_medium_context_budget: int = 16000

    # High tier
    tier_high_models: list[str] = Field(default=["anthropic/claude-opus-4-8", "openai/gpt-4o"])
